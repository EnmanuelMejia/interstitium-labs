...
(function (g) {
  ...
  function toMarkdown(data) {
    ...
    lines.push('## Noah', '- User turns: ' + data.museTurns, '- Goals completed: ' + data.museGoals, '');
    ...
    lines.push('## Links', '- Time-to-hire OS: https://interstitiumlabs.dev/os/', '- SuperLab: https://interstitiumlabs.dev/labs/superlab/', '- Adaptive OS: https://interstitiumlabs.dev/adapt/', '- Noah: https://interstitiumlabs.dev/coach/', '', '— Scientia Omnia Vincit');
    return lines.join('\n');
  }
