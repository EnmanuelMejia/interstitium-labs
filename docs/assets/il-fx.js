...
(function (global) {
  ...
  var CMD = [
    ...
    { label: "Noah — Coach", href: "/coach/", keys: "coach muse si tutor" },
    ...
    { label: "Noah · CrashLoopBackOff checks", href: "/coach/?prompt=" + encodeURIComponent("CrashLoopBackOff — first three checks."), keys: "muse prompt crashloop k8s" },
    { label: "Noah · CIDR /24 usable hosts", href: "/coach/?prompt=" + encodeURIComponent("Explain /24 usable hosts like an interviewer."), keys: "muse prompt cidr network" },
    { label: "Noah · readiness vs liveness", href: "/coach/?prompt=" + encodeURIComponent("Explain readiness vs liveness to a hiring manager."), keys: "muse prompt probe" },
