...
| FDE training | `/paths/fde-training/` | FDE Forge gamified spine | From ChatGPT `6ab1eabe…`; not BNY Prep |
| Enochian + programming | `/paths/enochian-programming/` | Source-critical DH + code | From ChatGPT `6ab1eb2c…`; not ritual school; dedupe vs SPA |
...
- `6ab1eabe-1f24-83ea-8f55-212e35a45529` — Create FDE Training Webapp → **Resolved** → `/paths/fde-training/`
- `6ab1eb2c-8158-83ea-baed-16b51daa823b` — Mastering Enochian Magic and Programming → **Resolved** → `/paths/enochian-programming/`

## Nav / sitemap wiring

Enroll + Admin linked from key static pages; Paths hub cards for FDE, BNY Full-Stack, Enochian+programming; Founders contact refreshed (Peabody / Greater Boston + Orlando targeting); `sitemap.xml` updated for new URLs.
