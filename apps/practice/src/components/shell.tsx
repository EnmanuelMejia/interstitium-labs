...
function NavLink({ to, on, children }: { to: "/" | "/about" | "/muse" | "/paths" | "/desk" | "/editor" | "/baseline" | "/school" | "/works" | "/academy" | "/data" | "/audit" | "/radar" | "/stack" | "/canon" | "/ladders" | "/manuals" | "/host"; on: boolean; children: ReactNode }) {
  return (
    <Link
      to={to}
      className={cn(
      ...
      <header className="sticky top-0 z-20 border-b border-line bg-bg">
        <div className="mx-auto flex max-w-6xl items-center gap-2 px-3 py-2 sm:gap-4 sm:px-6 sm:py-3">
          ...
          <nav className="ml-auto flex min-w-0 items-center gap-0.5 overflow-x-auto">
            ...
            <NavLink to="/about" on={pathname === "/about"}>
              About
            </NavLink>
            ...
            <NavLink to="/works" on={pathname === "/works"}>
              Works
            </NavLink>
            <NavLink to="/academy" on={pathname === "/academy"}>
              Academy
            </NavLink>
            <NavLink to="/data" on={pathname === "/data"}>
              Data
            </NavLink>
            <NavLink to="/audit" on={pathname === "/audit"}>
              Audit
            </NavLink>
