...
function NavLink({ to, on, children }: { to: "/" | "/muse" | "/paths" | "/desk" | "/editor" | "/baseline" | "/school" | "/works" | "/academy" | "/data" | "/audit" | "/radar" | "/stack" | "/canon" | "/ladders" | "/manuals" | "/host"; on: boolean; children: ReactNode }) {
  return (
    <Link
      to={to}
      className={cn(
